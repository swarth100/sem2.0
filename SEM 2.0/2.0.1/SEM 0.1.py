...
try:
    ...
    print 'ERROR OPENING SERIAL!!!'
    print 'ERROR OPENING SERIAL!!!'
    print 'Install PySerial for Version 2.8 or lower of Python'
    print ''
...
board = pygame.draw.rect(screen, [0, 0, 0], [100, 100, 400, 400], 0)
...
print 'NO SUPPORT WITH ARDUINO VERSION!'
print 'NO SUPPORT WITH ARDUINO VERSION!'
print 'NO SUPPORT WITH ARDUINO VERSION!'
print 'NO SUPPORT WITH ARDUINO VERSION!'
print 'NO SUPPORT WITH ARDUINO VERSION!'
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            while button1 == 1:
                ...
                if board.collidepoint (pos_x, pos_y):
                    if not piece_moving:
                        for i in range (0, len(white_piece_list)):
                            if white_piece_list[i].rect.collidepoint (pos_x, pos_y):
                                piece_moving = True
                                piece_moving = ['white', i]
                                starting_position = [pos_x, pos_y]
                                break
                            if black_piece_list[i].rect.collidepoint (pos_x, pos_y):
                                piece_moving = True
                                piece_moving = ['black', i]
                                starting_position = [pos_x, pos_y]
                                break
                    else:
                        if piece_moving[0] == 'white':
                            white_piece_list[i].move([pos_x - starting_position[0], pos_y - starting_position[1]])
                        else:
                            black_piece_list[i].move([pos_x - starting_position[0], pos_y - starting_position[1]])
